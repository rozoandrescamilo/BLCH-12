...
contract DoTrackStatusValidator {
    ...
    constructor() {
        allowedWallets[0x8BB20609D259f320e771Ce503833f83a05F4C563] = true; // agregar direccion de wallet permitida del cliente (wallet dawipo en kaleido)
        allowedWallets[0x1484eBFb39BCe3A77f415153a47B4BF1Ab5c76c7] = true; // agregar direccion de wallet permitida del proveedor
